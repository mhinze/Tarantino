...
namespace Tarantino.Core.Commons.Services.DataFileManagement.Impl
{
	...
	public class ExcelWorkbookReader : IExcelWorkbookReader
	{
		...
		/// </summary>
		class XlsBiffBOF : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffEOF : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffSimpleValueRecord : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffInterfaceHdr : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffDimensions : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffIndex : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffSST : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsFormattedUnicodeString
		{
			protected byte[] m_bytes;
			...
			public uint Size
			{
				get
				{
					uint extraSize = (uint)((HasFormatting) ? (2 + FormatCount * 4) : 0) +
					                 (uint)((HasExtString) ? (4 + ExtendedStringSize) : 0) + 3;
					if (!IsMultiByte)
		...
		/// </summary>
		class XlsBiffContinue : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffRow : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffDbCell : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffBlankCell : XlsBiffRecord
		{
		...
		/// </summary>
		class XlsBiffIntegerCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffMulBlankCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffNumberCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffLabelCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffRKCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffMulRKCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffLabelSSTCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffBoolErrCell : XlsBiffBlankCell
		{
		...
		/// </summary>
		class XlsBiffFormulaString : XlsBiffRecord
		{
			...
			public string Value
			{
				...
				{
					return
						m_UseEncoding.GetString(m_bytes, m_readoffset + 2 + ((m_UseEncoding.IsSingleByte) ? 1 : 2),
						                        Length * ((m_UseEncoding.IsSingleByte) ? 1 : 2));
				}
				// Turn off unicode encoding
		...
		/// </summary>
		class XlsBiffFormulaCell : XlsBiffNumberCell
		{
			...
			public new object Value
			{
				get
				{
					...
					if (((ulong)val & 0xFFFF000000000000) == 0xFFFF000000000000)
					{
						...
						{
							case 0: // String
								XlsBiffFormulaString str = GetRecord(m_bytes, (uint)(Offset + Size)) as XlsBiffFormulaString;
								if (str == null)
									return string.Empty;
								else
								{
		...
		/// </summary>
		class XlsBiffWindow1 : XlsBiffRecord
		{
			[Flags()]
		...
		/// </summary>
		class XlsBiffBoundSheet : XlsBiffRecord
		{
